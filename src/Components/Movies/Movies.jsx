...
export default function Movies() {
  ...
  async function getMoviesData(page) {
    let { data } = await axios.get(` https://api.themoviedb.org/3/discover/movie?api_key=7671d95579c1a821f90a3b7cf2b3a2bd&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=${page}`)
      ...
      <div className="container my-5 pb-5 all">
        ...
        <nav className='mt-5'>
          <ul className=' pagination pagination-sm d-flex justify-content-center'>
            {numList.map((page) => {
              return <li className=' page-item p-1' key={page} onClick={() => getMoviesData(page)}>
